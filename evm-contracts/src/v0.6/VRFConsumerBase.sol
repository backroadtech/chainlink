...
abstract contract VRFConsumerBase is VRFRequestIDBase {
  ...
  // fulfillRandomness_ is called by VRFCoordinator when it receives a valid VRF
  // proof. fulfillRandomness_ then calls fulfillRandomness, after validating
