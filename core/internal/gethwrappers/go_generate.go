...
//go:generate ./generation/generate.sh ../../../evm-contracts/abi/v0.6/VRFTestHelper.json solidity_vrf_verifier
...
//go:generate ./generation/generate.sh ../../../evm-contracts/abi/v0.6/VRFRequestIDBaseTestHelper.json solidity_vrf_request_id
